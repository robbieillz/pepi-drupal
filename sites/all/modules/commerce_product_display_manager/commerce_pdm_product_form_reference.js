Drupal.behaviors.commerce_pdm_form_commerce_product_ui_product_form_alter = {
  attach: function (context, settings) {
    ...
    (function ($) {
      ...
      var $table = $('table#commerce_pdm_product_referenced_by');
      var $newTitleInput = $table.find('input#edit-quick-reference-add-new-reference-actions-commerce-pdm-product-display-title');
      var $newTypeSelect = $table.find('select#edit-quick-reference-add-new-reference-actions-commerce-pdm-product-display-type');
      var $existingNidInput = $table.find('input#edit-quick-reference-add-new-reference-actions-commerce-pdm-product-display-existing');
      var $addButton = $table.find('a#edit-quick-reference-add-new-reference-actions-commerce-pdm-product-display-add');
      ...
      function addReferencedRow(title, nid, newType) {
        ...
        var $alternateRowClass = numRows % 2 ? 'even' : 'odd';
      ...
      function displayMessage(msg, messageType) {
        var $messageContainer = $('table#commerce_pdm_product_referenced_by div.commerce-pdm-product-form-reference-error-message');
       ...
       *
       */
      $('table#commerce_pdm_product_referenced_by').on('click', 'a.commerce-pdm-reference-delete', function () {
       ...
       *
       */
      $('table#commerce_pdm_product_referenced_by').on('click', 'a.commerce-pdm-reference-undo-delete', function () {
